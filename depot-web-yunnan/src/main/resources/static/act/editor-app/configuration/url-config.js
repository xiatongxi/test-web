...
KISBPM.URL = {
		...
		getModel: function(modelId) {
	        ...
	        return '/depot-business/act/service/model/' + modelId + '/json';
	    },

	    getStencilSet: function() {
	        /*return ACTIVITI.CONFIG.contextRoot + '/editor/stencilset?version=' + Date.now();*/
	        return '/depot-business/act/service/editor/stencilset?version=' + Date.now();
	    },

	    putModel: function(modelId) {
	        /*return ACTIVITI.CONFIG.contextRoot + '/model/' + modelId + '/save';*/
	        return '/depot-business/act/service/model/'+modelId +'/save';
	    }
};