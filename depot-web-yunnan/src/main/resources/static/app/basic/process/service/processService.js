...
angular.module('app.basic').service("processService", function($http, $q, APP_CONFIG) {
	//查询列表
    this.getPageInfo = function(pageNum, pageSize, keeperName, orgId) {
        var d = $q.defer();
        $http({
            method : 'GET',
            url : APP_CONFIG.basicUrl + '/BasicProcessMainController/getList',
            params : {
                pageNum : pageNum,
                pageSize : pageSize,
                orgId : orgId
    ...
    this.edit = function(id, orgId) {
        var d = $q.defer();
        $http({
            method : 'GET',
            url : APP_CONFIG.basicUrl + '/BasicProcessMainController/edit',
            params : {
                orgId : orgId,  //单位
                id : id  //仓房
            }
    ...
    this.getUnitStoreKeepList = function(id, orgId) {
    	var d = $q.defer(); 
    	$http({
             method: 'GET',
    ...
    //更新保管员移交对应保管员的仓房
    this.updateKeeperHouse = function(houseId,receiveId,transferId) {
        var d = $q.defer();
        $http({
            method: 'GET',
