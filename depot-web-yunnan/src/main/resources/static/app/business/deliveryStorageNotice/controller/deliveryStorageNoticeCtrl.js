angular.module('app.business').controller("deliveryStorageNoticeCtrl", function($scope, $http, $state, $uibModal,
     ...
     $scope.loadData = function() {
    	 if($stateParams.billType == "1" || $stateParams.billType == "3"){
    		 $scope.searchCondition = {billType: $stateParams.billType};
    	 }
     ...
     $scope.delete = function(deliveryStorageNotice) {
         ...
         $http({ 
             ...
             data: {
                 ...
                 planBid: deliveryStorageNotice.planBid,
                 contractBid : deliveryStorageNotice.contractBid
             }
