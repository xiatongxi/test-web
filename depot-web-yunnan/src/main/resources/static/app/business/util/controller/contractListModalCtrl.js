angular.module('app.business').controller("contractListModalCtrl", 
    ...
    $scope.loadData = function() {
    	contractService.getModalList($scope.pageInfo.pageNum, $scope.pageInfo.pageSize, $scope.searchCondition)
	    	.then(function(data) {
	    		$scope.pageInfo = data;
	    	})
	    	.catch(function(data) {
