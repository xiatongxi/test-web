...
angular.module('app.business').service("transferContractAuditService", function($http, $q,$rootScope, APP_CONFIG) {
    this.getPageInfo = function(pageNum, pageSize, searchCondition) {
        var d = $q.defer();
        $http({
            method : 'GET',
            url : APP_CONFIG.businessUrl + '/depot/business/contract/audit/getListTransfer',
            params : {
                pageNum : pageNum,
                pageSize : pageSize,
    ...
    this.getContractChangePageInfo = function(pageNum, pageSize, searchCondition) {
        ...
        $http({
            method : 'GET',
            url : APP_CONFIG.businessUrl + '/depot/business/contract/audit/getContractChangeListTransfer',
            params : {
                pageNum : pageNum,
                pageSize : pageSize,
                contractNumber : searchCondition == undefined?"" : searchCondition.contractNumber, 
