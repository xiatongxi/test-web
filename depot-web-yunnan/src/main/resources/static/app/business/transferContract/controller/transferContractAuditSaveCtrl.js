angular.module('app.business').controller("transferContractAuditSaveCtrl", 
		function($rootScope, $scope, $http, $stateParams, $state, $uibModal, $filter, 
				transferContractAuditService, enumService,userService, APP_CONFIG) {
  ...
  //签订人 信息
    ...
    $scope.loadDataById = function(id, processInstanceId) {
    	transferContractAuditService.loadDataById(id, processInstanceId, $scope.auditType).then(function(data){
