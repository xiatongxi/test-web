...
angular.module('app.business').service("transferNoticeService", function($http,$rootScope, $q, APP_CONFIG) {
    this.getPageInfo = function(pageNum, pageSize, searchCondition) {
        var d = $q.defer();
        $http({
            method : 'GET',
            url : APP_CONFIG.businessUrl + '/depot/business/deliveryStorageNotice/getListTransfer',
            params : {
                pageNum : pageNum,
                pageSize : pageSize,
                ...
                deliveryCustomer : searchCondition == undefined ? "" : searchCondition.deliveryCustomer,
