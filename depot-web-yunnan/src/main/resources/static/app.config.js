...
appConfig.safeProduceUrl = location.protocol+"//"+location.host+'/depot-safe-produce';
appConfig.numberManageUrl = location.protocol+"//"+location.host+'/depot-number-manage';
appConfig.drugManageUrl = location.protocol+"//"+location.host+'/depot-drug-manage';
...
appConfig.grainInspectionUrl = location.protocol+"//"+location.host+'/depot-grain-inspection';
...
appConfig.intelligentUrl = 'http://localhost:9028';
